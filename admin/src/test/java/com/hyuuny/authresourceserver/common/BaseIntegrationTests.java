...
public abstract class BaseIntegrationTests {
    ...
    protected String getBearerToken(final String username, final String password) {
        AuthenticationDto.LoginDto loginDto = AuthenticationDto.LoginDto.builder()
                ...
                .build();
        try {
            return this.getBearerToken(loginDto);
        } catch (Exception e) {
    ...
    protected String getBearerToken(AuthenticationDto.LoginDto loginDto) throws Exception {
        return "Bearer " + this.getAccessToken(loginDto);
    }
    ...
    public void deleteUsers() {
        userRepository.findAll().stream()
                ...
                .filter(user -> !Objects.equals(user.getUserAccount().getUsername(), MANAGER_EMAIL))
                .filter(user -> !Objects.equals(user.getUserAccount().getUsername(), USER_EMAIL))
