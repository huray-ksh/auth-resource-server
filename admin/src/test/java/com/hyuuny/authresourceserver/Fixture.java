...
public class Fixture {
    ...
    public static final String MANAGER_EMAIL = "basicManager@huray.net";

    public static final String MANAGER_PASSWORD = "c123455!!";
    ...
    public static UserDto.SignUpRequest.SignUpRequestBuilder anManager() {
        return UserDto.SignUpRequest.builder()
                .email(MANAGER_EMAIL)
                .password(MANAGER_PASSWORD)
                .name("매니저")
                .mobilePhoneNumber("010-1234-1239")
                .gender(Gender.MALE)
                .roleType(Role.RoleType.ROLE_SYS_MANAGER)
                .privilegeTypes(Lists.newArrayList(
                        Privilege.PrivilegeType.PRIVILEGE_ORGANIZATION,
                        Privilege.PrivilegeType.PRIVILEGE_USER_R,
                        Privilege.PrivilegeType.PRIVILEGE_USER_C,
    ...
    public static List<Role> aRoles() {
        return Lists.newArrayList(
                ...
                aRole()
                        ...
                        .build(),
                aRole()
                        .name("role.name.system.dev.manager")
                        .type(Role.RoleType.ROLE_SYS_DEV_MANAGER)
                        .description("role.description.system.dev.manager")
                        .build(),
                aRole()
                        .name("role.name.system.service.manager")
                        .type(Role.RoleType.ROLE_SYS_SERVICE_MANAGER)
                        .description("role.description.system.service.manager")
                        .build()
        );
    }
    ...
    public static List<Privilege> anManagePrivileges() {
        return Lists.newArrayList(
                aPrivilege()
                        .name("privilege.organization")
                        .type(Privilege.PrivilegeType.PRIVILEGE_ORGANIZATION)
    ...
    public static PostDto.Create.CreateBuilder aPost() {
